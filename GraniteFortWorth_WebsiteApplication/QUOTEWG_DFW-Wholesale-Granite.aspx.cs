...
{
    public partial class QUOTEWG_DFW_Wholesale_Granite : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                //Response.Redirect("/m/online-quote/QUOTEWG_DFW-Wholesale-Granite.aspx?OnlineQuoteID=" + Request.QueryString["OnlineQuoteID"]);
        ...
        protected void SendPDF(string filename)
        {
            ...
            builder.AppendLine("http://www.granitesouthlake.com/QUOTEWG_DFW-Wholesale-Granite.aspx?OnlineQuoteID=" + OnlineQuoteIDLabel.Text);
        ...
        {
            decimal totalCost = totalStones + totalSink + totalServices;
