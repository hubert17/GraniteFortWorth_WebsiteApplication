 ...
 (function($){
	$.fn.pagePeel = function(options){
		...
		var defaults = {
			...
			smallWidth: 120,
			smallHeight: 120,
			smallBG: 'Images/pp-src/smallBG.png',
			...
			bigWidth: 500,
			bigHeight: 500,
			bigBG: 'Images/pp-src/bigBG.png',
			bigAd: 'Images/pp-src/bigAd.jpg',
			bigSWF: 'Images/pp-src/page-peel-big.swf',
			...
			introAnim: false,
			bigSWFIntro: 'Images/pp-src/page-peel-big-intro.swf',
