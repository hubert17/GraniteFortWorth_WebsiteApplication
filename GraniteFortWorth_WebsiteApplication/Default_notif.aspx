...
<script type="text/javascript">
    ...
    <script type="text/javascript">
        window.onload = function () {
            setTimeout(function () { document.getElementById('light').style.display = 'block'; document.getElementById('fade').style.display = 'block' }, 3000)
        }
    </script>
...
<div id="light" class="white_content">
		    <img alt="Please be advised that our ONLINE QUOTE 
    and CONTACT page will be unavailable on July 25th, 2014
    Between 11 p.m. and 1 a.m. Central time. Our hosting provider will conduct upgrades which requires our 
    messaging server be taken offline for one to two hours. You can 
    browse the rest of our pages fluidly as normal." 
		    src="/Images/notif.gif" usemap="#custom_lightboxMap" style="border: none; outline: none;" />
		    <map id="custom_lightboxMap" name="custom_lightboxMap">
		    <area shape="rect" coords="621,0,699,72" href="#" onclick = "document.getElementById('light').style.display='none';document.getElementById('fade').style.display='none'" style="outline: none; cursor: pointer;">
		    </map>		
</div>
						...
						<section class="cols">
							<div class="box">
								<div>
									...
									<p class="pad_bot1">At DFW Wholesale Granite, we believe in taking the personal approach. </p>
