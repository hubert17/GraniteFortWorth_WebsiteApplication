...
<body ng-app>
    ...
    <div>
        ...
        <div class="DivToScroll" ng-controller="TodoCtrl">
            ...
            <asp:ListView ID="ListView1" runat="server" DataKeyNames="OnlineQuoteMeasureID" DataSourceID="SqlDataSource1" InsertItemPosition="LastItem" OnItemDeleted="ListView1_ItemDeleted" OnItemInserted="ListView1_ItemInserted" OnItemUpdated="ListView1_ItemUpdated" OnItemInserting="ListView1_ItemInserting" >
                ...
                <InsertItemTemplate>
                    <tr style="">
                        ...
                        <td style="width:100px;">
                            <asp:DropDownList ID="MeasureTextBox" runat="server" DataSourceID="SqlDataSource2" DataTextField="AssetName" DataValueField="AssetName" SelectedValue='<%# Bind("Measure") %>' ></asp:DropDownList>
                            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="Provider=Microsoft.ACE.OLEDB.12.0;Data Source=|DataDirectory|\DFWwebsiteDB.accdb;Persist Security Info=True" ProviderName="System.Data.OleDb" SelectCommand="SELECT [AssetName] FROM [tblMeasureAssets] WHERE Inactive=False"></asp:SqlDataSource>

                        </td>
                        <td style="width:50px;">
                            <asp:TextBox ID="LengthTextBox" runat="server" Text='<%# Bind("Length") %>' ng-model="x" Width="60px" />                            
                        </td>
                        <td style="width:50px;">
                            <asp:TextBox ID="WidthTextBox" runat="server" Text='<%# Bind("Width") %>'  ng-model="y" Width="60px"  />
                        </td>
                        <td style="width:50px;">
                              <input type="text" value="{{total() | number:3}}" style="width:60px;"/>  &nbsp;&nbsp;&nbsp;
                            ...
                            <td id="Td1" runat="server">
                                ...
                                <thead>
                                    <tr id="Tr2" runat="server" style="">
                                        ...
                                        <th id="Th5" runat="server" style="width:100px">Area</th>
                                    </tr>
                                </thead>
                                <tbody>
        ...
        <br />
            <div style="text-align:right;padding-right:10px;">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="TotalSFplus" runat="server" Text="Total SF + %: "></asp:Label><asp:TextBox ID="TotalSquareFootTextBoxPlus10" runat="server" style="text-align:right" BorderColor="Black" Width="60px"></asp:TextBox>
