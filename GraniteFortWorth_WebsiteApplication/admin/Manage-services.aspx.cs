...
namespace GraniteFortWorth_WebsiteApplication.admin
{
    public partial class Manage_services : System.Web.UI.Page
    {
        ...
        protected void ShowInactiveCheckBox_CheckedChanged(object sender, EventArgs e)
        {
            if (!ShowInactiveCheckBox.Checked)
                ListBox1.DataSourceID = SqlDataSource2.ID;
            else
                ListBox1.DataSourceID = SqlDataSource3.ID;
        }
