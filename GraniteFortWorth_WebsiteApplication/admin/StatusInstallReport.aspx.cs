...
{
    public partial class StatusInstallReport : System.Web.UI.Page
    {
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (ShowAll)
            {
                ...
                {
                    //strJobID = HttpUtility.ParseQueryString(e.Row.Cells[3].Text).Get("OnlineQuoteID");
                    ...
                    if (strJobID != null)
                    {
                        ...
                        while (SinkDataReader.Read())
                        {
                            ...
                            {
                                e.Row.Cells[4].Text += "<br>●<em>" + ex.Message + "</em>";
                            }
                        }
