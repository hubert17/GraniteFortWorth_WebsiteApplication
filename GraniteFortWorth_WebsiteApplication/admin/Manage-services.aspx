    ...
    <form id="form1" runat="server">
       <div class="container">
			...
			<div style="width:390px;float:left;padding-top:0px;">
                <h3><span style="float:left;margin-left:30px;">Select an item to Edit</span>
                    <span style="float:right;margin-right:35px;"><asp:CheckBox ID="ShowInactiveCheckBox" runat="server" OnCheckedChanged="ShowInactiveCheckBox_CheckedChanged" Text=" Show Inactive" AutoPostBack="True" /></span>
                </h3>
            ...
            <asp:FormView ID="FormView1" runat="server" DataSourceID="SqlDataSource1" DataKeyNames="ServicesID" DefaultMode="Edit" OnItemInserted="FormView1_ItemInserted" OnItemUpdated="FormView1_ItemUpdated" OnItemDeleted="FormView1_ItemDeleted" Width="360px">
                    <EditItemTemplate>
                        Service Name:
                        <asp:TextBox ID="ServiceNameTextBox" runat="server" Text='<%# Bind("ServiceName") %>' Enabled="False" />
                        <br />
                        Price:<br />
                        ...
                        <br />
                         <asp:CheckBox ID="InactiveCheckBox" runat="server" Text=" Inactive" Checked='<%# Bind("Inactive") %>' Width="300px" />
                        <br />

                        <p class="submit">
                            <asp:Button ID="UpdateButton" runat="server" CausesValidation="True" CommandName="Update" Text="Save" />
                            &nbsp;<asp:Button ID="UpdateCancelButton" runat="server" CausesValidation="False" CommandName="Cancel" Text="Cancel" />
                                &nbsp;<asp:Button ID="DeleteButton" runat="server" CausesValidation="False" CommandName="Delete" Text="Delete" OnClientClick='return confirm(&apos;About to delete. Are you sure?&apos;);' Enabled="False" />
                        </p>
