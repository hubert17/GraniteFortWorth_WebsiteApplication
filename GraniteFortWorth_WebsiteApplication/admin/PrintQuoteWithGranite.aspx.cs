...
{
    public partial class PrintQuoteWithGranite : System.Web.UI.Page
    {
        ...
        protected void SendPDF(string filename)
        {
            ...
            builder.AppendLine("http://www.granitesouthlake.com/admin/PrintQuoteWithGranite.aspx?OnlineQuoteID=" + OnlineQuoteIDLabel.Text);
        ...
        protected void DisplayTotalCost()
        {
            ...
            try
            {
                ...
                totalCost = totalStones + totalSink + totalServices;
