<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StatusCabinetsReport.aspx.cs" Inherits="GraniteFortWorth_WebsiteApplication.admin.StatusCabinetsReport" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" CssClass="onlyonscreen">
           <asp:ListItem Value="TaskDate" Selected="True">Cabinets</asp:ListItem>
        ...
        <h4>DFW Wholesale Granite</h4>        
        <h2 style="margin-bottom:20px;">Cabinets Task Report </h2>
