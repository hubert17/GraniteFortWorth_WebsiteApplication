<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StatusInstallReport.aspx.cs" Inherits="GraniteFortWorth_WebsiteApplication.admin.StatusInstallReport" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <h4>DFW Wholesale Granite</h4>        
        <h2 style="margin-bottom:20px;">Job Install Report </h2>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="None" OnRowDataBound="GridView1_RowDataBound">
            <Columns>
                <asp:BoundField DataField="InstallTime" HeaderText="INSTALL TIME" ReadOnly="True" DataFormatString="{0:MM/dd/yyyy}" >
