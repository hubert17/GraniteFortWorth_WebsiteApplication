<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StatusTemplateReport.aspx.cs" Inherits="GraniteFortWorth_WebsiteApplication.admin.StatusTemplateReport" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" CssClass="onlyonscreen">
           <asp:ListItem Value="TaskDate" Selected="True">Template</asp:ListItem>
        ...
        <h4>DFW Wholesale Granite</h4>        
        <h2 style="margin-bottom:20px;">Job Template Report </h2>
